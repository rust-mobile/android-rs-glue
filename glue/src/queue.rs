...
impl AInputQueue {
    ...
    ///
    /// By calling this function, you assert that the pointer is a valid, non-null pointer to an
    /// NDK `AInputQueue`.
    pub unsafe fn from_ptr(ptr: *mut ffi::AInputQueue) -> Self {
        Self { ptr }
    }
